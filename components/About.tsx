    ...
    <section id="about" className="py-16 border-t border-slate-200 dark:border-white/5">
      ...
      >
        ...
        <div className="space-y-6 text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl">
          <p>
            I'm Varuntej Reddy N, a Computer Science graduate passionate about building web applications and exploring AI/ML technologies. I'm actively seeking internship opportunities to apply my academic knowledge and grow as a developer.
          </p>
          <p>
