...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main className="max-w-screen-md mx-auto px-4 sm:px-6 pb-24 sm:pb-32">
        <Hero />
        <About />
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 sm:bottom-10 sm:right-10 z-[55] w-14 h-14 sm:w-16 sm:h-16 bg-green-500 text-white rounded-full flex items-center justify-center shadow-2xl hover:scale-110 active:scale-95 transition-transform"
      >
